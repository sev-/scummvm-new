...
begin_credits("Credits");
	...
	begin_section("Other contributions", "other_contrib");
		...
		begin_section("GUI Translations (with 10+ translations)", "gui_translations");
				...
				end_section();
				begin_section("Czech");
					add_person("Zbyn&igrave;k Schwarz", "tsbook", "");
		...
		begin_section("Game Translations", "game_translations");
				begin_section("CGE");
					add_person("Arnaud Boutonn&eacute;", "Strangerke", "Soltys English translation");
				...
				begin_section("Mortevielle");
					add_person("Arnaud Boutonn&eacute;", "Strangerke", "First English translation, improve German translation");
